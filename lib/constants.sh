...
# Messages - Warnings
MSG_WARN_NOT_LARAVEL="No parece ser un proyecto Laravel (no se encontró artisan)"
MSG_WARN_NO_PROJECT="No hay proyecto configurado"
MSG_WARN_FILE_EXISTS="ya existe"
MSG_WARN_NO_ENV="No existe $DOCK_ENV, ejecuta './dock init' primero"
MSG_WARN_DESTROY="Esta acción eliminará:"
MSG_WARN_DESTROY_CONTAINERS="  - Todos los contenedores del proyecto"
MSG_WARN_DESTROY_VOLUMES="  - Todos los volúmenes (incluyendo base de datos)"
MSG_WARN_DESTROY_IMAGES="  - Todas las imágenes construidas"
...
MSG_INFO_DELETING="Eliminando todo..."
MSG_INFO_CANCELLED="Cancelado"
...
MSG_INFO_RUNNING_MIGRATIONS="Ejecutando migraciones..."
MSG_INFO_RUNNING_FRESH="Ejecutando migrate:fresh --seed..."
